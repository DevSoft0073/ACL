...
protocol KAudioRecorderDelegate: class {
    func didPlayFinish()
...
class KAudioRecorder: NSObject {
    ...
    weak var delegate: KAudioRecorderDelegate?
    ...
    func getFileURL() -> URL {
         return getDir().appendingPathComponent(recordName?.appending(".m4a") ?? "sound.m4a")
    }

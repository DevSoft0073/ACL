...
class MenuTabsView: UIView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
   ...
   lazy var collView: UICollectionView = {
    ...
    var cellId = "LibrarySearchTabViewCell"
    ...
    private func customIntializer () {
        ...
        collView.register(LibrarySearchTabViewCell.self, forCellWithReuseIdentifier: cellId)
        addSubview(collView)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as? LibrarySearchTabViewCell {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        if isSizeToFitCellsNeeded {
            ...
            let estimatedRect = NSString.init(string: str).boundingRect(with: sizeee, options: options, attributes: [NSAttributedString.Key.font : UIFont.boldSystemFont(ofSize: 20)], context: nil)

...
open class TTSegmentedControl: UIView {
    ...
    @IBInspectable open var thumbBorderColor: UIColor = UIColor.clear
    @IBInspectable open var thumbBorderWidth: CGFloat = 0
...
extension TTSegmentedControl {
    ...
    fileprivate func updateSelectedViewFrame() {
        ...
        thumbContainerView.borderWidth = thumbBorderWidth
        thumbContainerView.borderColor = thumbBorderColor
